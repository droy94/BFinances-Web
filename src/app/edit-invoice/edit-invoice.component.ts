...
//   editInvoiceForm = this.formBuilder.group({
...
//       id: 0,
//       number: null,
//       forContractor: this.editInvoiceForm.get("forContractor").value,
//       invoiceDate: this.editInvoiceForm.get("invoiceDate").value,
//       dueDate: this.editInvoiceForm.get("dueDate").value,
//       saleDate: this.editInvoiceForm.get("saleDate").value,
//       netAmount: Number(this.editInvoiceForm.get("netAmount").value),
//       vatPercent: Number(this.editInvoiceForm.get("vatPercent").value),
//       numberOfUnits: Number(this.editInvoiceForm.get("numberOfUnits").value),
//       unitName: this.editInvoiceForm.get("unitName").value,
//       pkwiu: this.editInvoiceForm.get("pkwiu").value,
//     };
